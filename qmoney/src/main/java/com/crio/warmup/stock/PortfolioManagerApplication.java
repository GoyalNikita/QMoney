...
public class PortfolioManagerApplication {
  ...
  public static PortfolioManager portfolioManager = PortfolioManagerFactory.getPortfolioManager( null, restTemplate);
  ...
  // private static final String TOKEN = "d7a891c38455ab0ac3db9d6cc834953a67f430eb";
  private static final String TOKEN = "953e5d1702c35f1aabd7a475fd8d256e2274d731";
  ...
  public static List<AnnualizedReturn> mainCalculateSingleReturn(String[] args)
    ...
    for (PortfolioTrade portfolioTrade : portfolioTrades) {
      ...
      double sellprice = Stream.of(tiingoCandles).filter(candle -> candle.getDate().equals(endDate))
  ...
  public static List<Candle> fetchCandles(PortfolioTrade trade, LocalDate parse, Object token) {
    String url = prepareUrl(trade, parse, (String) token);
    RestTemplate restTemplate = new RestTemplate();
